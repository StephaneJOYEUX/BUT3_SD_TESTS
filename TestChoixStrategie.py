...
class TestChoixStrategie(TestCase):
    ...
    def test_ecriture_fichier_sauvegarde(self):
        ...
        df_new_data = pd.DataFrame(new_data, columns=["mode_jeu", "index_strategie", "nom", "taille", "coord_x", "coord_y", "orientation"])
        ...
        df_ligne_ecrite_test = self.choix_strategie_2.get_referentiel()[self.choix_strategie_2.get_referentiel().index_strategie == index_test]
        ...
        self.choix_strategie_3 = ChoixStrategie("mon_pseudo_3", navires=self.navires, test=True, grille=self.grille,
                                              mode_jeu=self.mode_jeu)
